        ...
        onBoardingItemAdapter = OnBoardingItemAdapter(
            listOf(
                OnBoardingItem(
                    ...
                    onBoardingDescription = "আপনার স্বাস্থ্য এবং ওষুধ গুরুত্বপূর্ণ, এই অ্যাপটি আপনাকে \nআপনার নার্স এর মতনই খেয়াল রাখবে"
                ),OnBoardingItem(
                    onBoardingHeader = "মেডি হেল্প",
                    onBoardingImage = R.drawable.onboardingimage_two,
                    onBoardingTitle = "সময় শর্তর্কীকরণ",
                    onBoardingDescription = "এই অ্যাপটি আপনাকে মনে করিয়ে দেবে কখন কোন ধরনের \nঔষধ আপনার প্রয়োজন"
                ),OnBoardingItem(
                    onBoardingHeader = "মেডি হেল্প",
                    onBoardingImage = R.drawable.onboardingimage_three,
                    onBoardingTitle = "আপনার পরিবারের যত্ন নিন",
                    onBoardingDescription = "এর সাহায্যে আপনি কেবল নিজেরই যত্ন নিতে পারবেন না, আপনার \nপরিবারের অন্যান্য সদস্যদেরও যত্ন নিতে পারবেন"
                ),
            ))
